...
def normalize_mode(value: str | None) -> str:
    ...
    aliases = {
        ...
        "keep_mcc_mnc_pseudonymize_msin": ProtectionMode.KEEP_MCC_MNC_PSEUDONYMIZE_MSIN.value,
        "keep-mcc-mnc-pseudonymize-msin": ProtectionMode.KEEP_MCC_MNC_PSEUDONYMIZE_MSIN.value,
        "keep_plmn_pseudonymize_msin": ProtectionMode.KEEP_MCC_MNC_PSEUDONYMIZE_MSIN.value,
        "keep-plmn-pseudonymize-msin": ProtectionMode.KEEP_MCC_MNC_PSEUDONYMIZE_MSIN.value,
        ...
        "keep_e164_routing_mask_subscriber": ProtectionMode.KEEP_CC_NDC_MASK_SUBSCRIBER.value,
        "keep-e164-routing-mask-subscriber": ProtectionMode.KEEP_CC_NDC_MASK_SUBSCRIBER.value,
        "keep_cc_ndc_pseudonymize_subscriber": ProtectionMode.KEEP_CC_NDC_PSEUDONYMIZE_SUBSCRIBER.value,
        "keep-cc-ndc-pseudonymize-subscriber": ProtectionMode.KEEP_CC_NDC_PSEUDONYMIZE_SUBSCRIBER.value,
        "keep_e164_routing_pseudonymize_subscriber": ProtectionMode.KEEP_CC_NDC_PSEUDONYMIZE_SUBSCRIBER.value,
        "keep-e164-routing-pseudonymize-subscriber": ProtectionMode.KEEP_CC_NDC_PSEUDONYMIZE_SUBSCRIBER.value,
        ...
        "keep_e164_routing_encrypt_subscriber": ProtectionMode.KEEP_CC_NDC_ENCRYPT_SUBSCRIBER.value,
        "keep-e164-routing-encrypt-subscriber": ProtectionMode.KEEP_CC_NDC_ENCRYPT_SUBSCRIBER.value,
    }
